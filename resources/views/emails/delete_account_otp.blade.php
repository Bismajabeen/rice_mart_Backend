        ...
        <div class="body">
            ...
            <div class="warning-note">
                ...
                <ul>
                    ...
                    <li>Your shop and product listings (if any)</li>
                    <li>All associated data from Rice Mart</li>
                </ul>
            </div>

            <!-- Ignore note -->
            <p class="ignore-note">
                If you did <strong>not</strong> request account deletion,
                please ignore this email. Your account will remain safe.
            </p>
